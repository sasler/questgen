...
- World topology is generated by deterministic code from a per-game seed
...
- `RoomInfoPanel` and `/hint` both rely on the same authoritative interactable state, while hidden debug commands stay out of the player-facing UI
